...
const Footer = () => {
  return (
    <footer className="footer items-center p-4 text-slate-700 border-t-2 text-neutral-content w-auto px-4">
      <aside className="items-center grid-flow-col sm:place-self-center sm:justify-self-center">
        ...
        <p>Copyright © 2024 - Brain child of  Wali</p>
      </aside>
      <nav className="grid-flow-col gap-4 sm:place-self-center sm:justify-self-center">
